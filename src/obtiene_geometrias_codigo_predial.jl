function obtiene_geometrias_codigo_predial(codigo_predial, conn_neo4j)
    ...
    ps_predio_db = polyShape.polyshapeToUTM(ps_predio_db)
    ...
    ps_predios_manzanas_vecinas = polyShape.polyshapeToUTM(ps_predios_manzanas_vecinas)
    ...
    ps_areas_verdes = polyShape.polyshapeToUTM(ps_areas_verdes)
    ...
    ps_manzanas_vecinas = polyShape.polyshapeToUTM(ps_manzanas_vecinas)
