function obtiene_geometrias_codigo_predial(codigo_predial, conn_neo4j)
    ...
    ps_predio_db = polyShape.polyshape_4326to32719(ps_predio_db)
    ...
    ps_predios_manzanas_vecinas = polyShape.polyshape_4326to32719(ps_predios_manzanas_vecinas)
    ...
    ps_areas_verdes = polyShape.polyshape_4326to32719(ps_areas_verdes)
    ...
    ps_manzanas_vecinas = polyShape.polyshape_4326to32719(ps_manzanas_vecinas)
