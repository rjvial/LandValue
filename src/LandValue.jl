...
using JuMP, Cbc, Ipopt, ArchGDAL, DotEnv, LinearAlgebra, Optim, OrderedCollections
    ...
    include("opti_floor_plan_ns.jl")
    include("opti_floor_plan_oe.jl")
    ...
    export obtiene_requerimientos_normativos, generaSombraEdificio, opti_edificio_deptos, opti_floor_plan_ns,
        opti_floor_plan_oe, polyShape, polyPlot, polyGdal, polyClipper, graphMod, resultConverter, plotBaseEdificio3D, generaSombraTeor,
