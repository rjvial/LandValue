...
let codigo_predial = [151600140900011, 151600140900012, 151600140900013, 151600140900018, 151600140900019, 151600140900020, 151600140900021, 151600140900022]
...
#pg_dump -h aws-landengines-db.cggiqowut9c4.us-east-1.rds.amazonaws.com -U postgres -d landengines_dev -t "datos_predios_vitacura" -t "datos_roles_vitacura" | psql -d landengines_local -h localhost -U postgres