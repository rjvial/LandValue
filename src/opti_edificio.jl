...
function opti_edificio(dict_geom, dict_arquitectura, dict_requerimientos)
    ...
    if config_edificio["flag_economica"]
        ...
        coefSupComun = dict_arquitectura["coefSupComun"]
    ...
    dict_proyecto_vs_normativa = OrderedDict(
        ...
        "pisos_proyecto" => Int8(sum(vec_np_opt[i] for i in eachindex(vec_ps_opt))),
        "pisos_normativa" => Int8(dict_requerimientos["n_pisos"]),
